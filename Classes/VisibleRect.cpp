...
void VisibleRect::lazyInit()
{
    if (s_visibleRect.size.width == 0.0f && s_visibleRect.size.height == 0.0f)
    {
        ...
        CCLog("VisibleRect origin x=%f,y=%f",s_visibleRect.origin.x,s_visibleRect.origin.y);
        CCLog("VisibleRect size width=%f,height=%f",s_visibleRect.size.width,s_visibleRect.size.height);
    }
}
